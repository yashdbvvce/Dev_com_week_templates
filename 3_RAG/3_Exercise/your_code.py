...
def create_vector_store():
    ...
    file_path = os.path.join(dir_name, 'books', 'adventures_of_sherlock_holmes.txt')
    persistant_directory = os.path.join(dir_name, 'db_store', 'chroma_db_harry_potter')
...
def get_similar_docs(query):
    ...
    persistant_directory = os.path.join(current_dir, "db_store", "chroma_db_harry_potter")
